...
function EditPaziente({ newPaziente, setNewPaziente, onClickClose, setStep }) {
      ...
      prevSessions.map((session) =>
        session.id === id
          ? {
              ...
              dayName: day.name,
              edit: session.edit !== 'added' ? 'updated' : session.edit,
            }
          : session
      )
    );
  ...
  const checkValues = async () => {
    ...
    if (passInsertCodFis) {
      const cf = new CodiceFiscale({
        ...
        day: parseInt(newPaziente.birthdate.day),
        month: parseInt(newPaziente.birthdate.month),
        year: parseInt(newPaziente.birthdate.year),
